      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">WallArt</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-sm">
              Transform your space with our premium wallpapers. From botanical
              bliss to modern minimalism, we have the perfect design for every
              home.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@wallart.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col lg:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 WallArt. All rights reserved.
          </p>
